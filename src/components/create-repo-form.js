        ...
        return (
            <Form>
                <FormGroup>
                    ...
                    <Input name="repoTitle" type="text" onChange={this.handleInputChange} required="True"/>
                </FormGroup>
                <FormGroup>
                    <Label>Repository description</Label>
                    <Input name="description" type="textarea" onChange={this.handleInputChange}/>
                </FormGroup>
                <FormGroup>
...
class EmailInput extends Component {
    ...
    render() {
        ...
        return <TagsInput
            ...
            className={`react-tagsinput ${!this.state.valid && 'border-danger'}`}
