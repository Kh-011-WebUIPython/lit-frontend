...
const HowToStart = () => (
  <section className="p-5">
    <div className="container pb-4">
      ...
      <p className="pb-3">In case you downloaded or cloned the
                    source code from GitHub or your own fork,
                    you can run the following to install cameo for
                    development:
      </p>
      <Code>$ git clone
                    https://github.com/Kh-011-WebUIPython/lit-cli
      </Code>
